package protego.bluelight.screenfilter.ui;
...
import protego.bluelight.screenfilter.receiver.ActionReceiver;
import protego.bluelight.screenfilter.service.MaskService;
import protego.bluelight.screenfilter.ui.adapter.ModeListAdapter;
import protego.bluelight.screenfilter.ui.dialog.SchedulerDialog;
import protego.bluelight.screenfilter.util.AlarmUtil;
...
public class MainActivity extends Activity {
    ...
    private TextView mAdvancedModeText,mAppName;
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                if (pm != null && !pm.isIgnoringBatteryOptimizations(getPackageName())) {
                    new AlertDialog.Builder(MainActivity.this)
                            ...
                            .setPositiveButton(R.string.proceed, (d, i) -> showSchedulerDialog())
